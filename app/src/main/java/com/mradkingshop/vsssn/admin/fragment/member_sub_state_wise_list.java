...
public class member_sub_state_wise_list extends Fragment {
    ...
    private void create_list(String state) {
        ...
        firebaseFirestore.collection("user_list").whereEqualTo("state",state)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if(documentSnapshot.size()==0){
                            ...
                            mProductList.add(new StateWiseModal(state,String.valueOf(documentSnapshot.size()),"no"));
