...
public class today_donation_list extends Activity {

    private RecyclerView cart_recycler_view;
    private List<PlanModal> productList;
    private Activity activity = today_donation_list.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        latestGovtJobRecyclerAdapter = new PlaneListAdapter( activity,productList,"admin_donation");
                ...
                public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                    ...
                    if (isFirstPageFirstLoad) {
                        ...
                        if (documentSnapshots.isEmpty()) {
                            ...
                            Toast.makeText(getApplicationContext(), "yet no donation recive today", Toast.LENGTH_SHORT).show();
