...
public class member_list_acording_state extends Activity {

    private RecyclerView cart_recycler_view;
    private List<PlanModal> productList;
    private Activity activity = member_list_acording_state.this;
    ...
    private void shop_list() {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            Query firstQuery =   firebaseFirestore.collection("user_list")
    ...
    private void loadMorePost() {
        ...
        Query nextQuery =  firebaseFirestore.collection("user_list")
                .whereEqualTo("state",getIntent().getExtras().getString("key"))
