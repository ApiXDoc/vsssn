...
public class donation_list_main extends Fragment {
    ...
    private void setupViewPager(ViewPager2 viewPager) {
        ...
        adapter.addFragment(new donation_sub_member_list(), "Member List");
        adapter.addFragment(new donation_plane_wise_collection(),"Plane Wise");
        adapter.addFragment(new donation_sub_state_wise(), "State Wise");
