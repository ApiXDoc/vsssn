...
public class donation_list_acording_state extends Activity {

    private RecyclerView cart_recycler_view;
    private List<PlanModal> productList;
    private Activity activity = donation_list_acording_state.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        latestGovtJobRecyclerAdapter = new PlaneListAdapter( activity,productList,"memberlist");
    ...
    private void shop_list() {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            Query firstQuery =   firebaseFirestore.collection("donation_list")
                    .whereEqualTo("state",getIntent().getExtras().getString("key"))
