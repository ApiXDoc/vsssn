...
public class other_data_home_page extends Fragment {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(filePath!=null){
                    ...
                    map.put("home_main_heading",home_page_heading.getText().toString());
                    map.put("home_page_dis",Discreption.getText().toString());
                    map.put("home_page_title",title.getText().toString());
                    map.put("home_reg",reg_no.getText().toString());
        ...
        Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    map.put("home_page_image_url",main_product_image1_url1);
