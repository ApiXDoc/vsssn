...
import com.mradkingshop.vsssn.admin.fragment.donation_sub_member_list;
import com.mradkingshop.vsssn.admin.fragment.donation_sub_state_wise;
...
public class user_home_page extends Fragment {
    ...
    private void setupViewPager(ViewPager2 viewPager) {
        ...
        adapter.addFragment(new user_home_about_us(), "Home");
        adapter.addFragment(new user_home_recently_donation(), "Recent Donation");
