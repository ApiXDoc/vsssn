...
import com.mradkingshop.vsssn.user.interf.inter;

import java.util.ArrayList;
import java.util.List;

public class user_proofs extends Fragment {
    ...
    private void setupViewPager(ViewPager2 viewPager) {
        ...
        adapter.addFragment(new user_proofs_recent_proof(), "Recent Proof");
        adapter.addFragment(new user_proofs_old_proof(), "Old Proof");
